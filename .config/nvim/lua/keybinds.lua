...
-- make <Esc> and jk work normally in terminal mode
map('t', '<Esc>', t('<C-\\><C-n>'), { noremap = true, silent = true })
map('t', 'jk', t('<C-\\><C-n>'), { noremap = true, silent = true })
...
-- Comment.nvim
------------------------
map('n', '<leader>c', t(':lua require("Comment").toggle()<CR>'), { noremap = true, silent = true })
map('v', '<leader>c', t(':lua require("Comment").toggle()<CR>'), { noremap = true, silent = true })
