...
function M.setup()
  vim.cmd([[
      augroup TrailingWhitespace
        au!
        au WinEnter,BufEnter,InsertLeave * lua require('my.whitespace').highlight()
        au WinLeave,BufLeave,InsertEnter * lua require('my.whitespace').unhighlight()
        au BufWritePre * lua require('my.whitespace').trim()
        au OptionSet buftype lua require('my.whitespace').track_normal_buffer()
      augroup END
      hi default TrailingWhitespace guibg=#ef596f ctermbg=red
    ]])
end
