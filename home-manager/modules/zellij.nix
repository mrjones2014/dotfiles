      ...
      default_tab_template {
        pane size=1 borderless=true {
              plugin location="file:${pkgs.zjstatus}/bin/zjstatus.wasm" {
                ...
                mode_tmux          "#[fg=$purple,bg=$bg_dark,bold]#[bg=$purple,fg=$bg_dark,bold]   #[bg=$bg,fg=$purple]"
                mode_locked        "#[fg=$red,bg=$bg_dark,bold]#[bg=$red,fg=$bg_dark,bold]   #[bg=$bg,fg=$red]"
                ...
                mode_rename_tab    "#[fg=$yellow,bg=$bg_dark,bold]#[bg=$yellow,fg=$bg_dark,bold]   #[bg=$bg,fg=$yellow]"
                mode_rename_pane   "#[fg=$yellow,bg=$bg_dark,bold]#[bg=$yellow,fg=$bg_dark,bold]   #[bg=$bg,fg=$yellow]"
                ...
                tab_normal              "#[bg=$bg,fg=$comment]#[bg=$bg_dark,fg=$comment,bold]#[bg=$comment,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$comment,bold] {name}{floating_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
                tab_normal_fullscreen   "#[bg=$bg,fg=$comment]#[bg=$bg_dark,fg=$comment,bold]#[bg=$comment,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$comment,bold] {name}{fullscreen_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
                tab_normal_sync         "#[bg=$bg,fg=$comment]#[bg=$bg_dark,fg=$comment,bold]#[bg=$comment,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$comment,bold] {name}{sync_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
                tab_active              "#[bg=$bg,fg=$blue]#[bg=$bg_dark,fg=$blue,bold]#[bg=$blue,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$blue,bold] {name}{floating_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
                tab_active_fullscreen   "#[bg=$bg,fg=$blue]#[bg=$bg_dark,fg=$blue,bold]#[bg=$blue,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$blue,bold] {name}{fullscreen_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
                tab_active_sync         "#[bg=$bg,fg=$blue]#[bg=$bg_dark,fg=$blue,bold]#[bg=$blue,fg=$bg_dark,bold]{index} #[bg=$bg_highlight,fg=$blue,bold] {name}{sync_indicator}#[bg=$bg_dark,fg=$bg_highlight]#[bg=$bg_dark,fg=$bg_highlight]"
