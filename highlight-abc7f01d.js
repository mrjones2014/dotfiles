...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `json` grammar compiled for Highlight.js 11.7.0 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `node-repl` grammar compiled for Highlight.js 11.7.0 */
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `ruby` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
