...
# This script is a subset of the script here: https://github.com/mathiasbynens/dotfiles/blob/master/.macos
...
# Finder: use list view for all windows by default
...
# Don't indicator lights for open applications in the Dock
...
# Disable AutoFill (I use 1Password for this)
