...
grep "switch --flake" "$SCRIPT_DIR/home-manager/modules/fish.nix" | sed 's/"//g; s/;//g' | sed 's/^/NIX_CONFIG="experimental-features = nix-command flakes"/' | sed -e 's/\(.*\)/\x1b[38;5;166m\1\x1b[0m/' | awk '{$1=$1;print}'
echo
