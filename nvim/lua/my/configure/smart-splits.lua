...
return {
  ...
  keys = {
    ...
    { '<M-h>', lazymap('smart-splits', 'resize_left'), desc = 'Resize window left' },
    { '<M-j>', lazymap('smart-splits', 'resize_down'), desc = 'Resize window down' },
    { '<M-k>', lazymap('smart-splits', 'resize_up'), desc = 'Resize window up' },
    { '<M-l>', lazymap('smart-splits', 'resize_right'), desc = 'Resize window right' },
