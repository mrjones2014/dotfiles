...
in stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url =
      "https://cdn1.waterfox.net/waterfox/releases/${finalAttrs.version}/Linux_x86_64/waterfox-${finalAttrs.version}.tar.bz2";
    hash = "sha256-lODOZQ980Af8mF8Pyd8YZ5ENkBhJwrBEE1KhPGEePUI=";
  };

  nativeBuildInputs = [ wrapGAppsHook3 unzip patchelf makeWrapper ];
  ...
  meta = {
    ...
    changelog =
      "https://github.com/BrowserWorks/Waterfox/releases/tag/${version}";
